        ...
        editor.widgets.add( 'widgetbootstrapTwoCol', {
            ...
            template:
                '<div class="row two-col">' +
                    '<div class="col-med-6 col-1"><p><img src="http://placehold.it/550x250&text=Image" /></p><p>Content</p></div>' +
                    '<div class="col-med-6 col-2"><p><img src="http://placehold.it/550x250&text=Image" /></p><p>Content</p></div>' +
                '</div>',
        ...
        editor.widgets.add( 'widgetbootstrapThreeCol', {
            ...
            template:
                '<div class="row three-col">' +
                    '<div class="col-med-4 col col-1"><p><img src="http://placehold.it/300x250&text=Image" /></p><p>Text below</p></div>' +
                    '<div class="col-med-4 col col-2"><p><img src="http://placehold.it/300x250&text=Image" /></p><p>Text below</p></div>' +
                    '<div class="col-med-4 col col-3"><p><img src="http://placehold.it/300x250&text=Image" /></p><p>Text below</p></div>' +
                '</div>',
